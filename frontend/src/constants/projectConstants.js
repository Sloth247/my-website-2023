...
export const PROJECT_UPDATE_REQUEST = 'PROJECT_CREATE_REQUEST';
export const PROJECT_UPDATE_SUCCESS = 'PROJECT_UPDATE_SUCCESS';
export const PROJECT_UPDATE_FAIL = 'PROJECT_CREATE_FAIL';
export const PROJECT_UPDATE_RESET = 'PROJECT_CREATE_RESET';
